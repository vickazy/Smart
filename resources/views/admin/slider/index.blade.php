...
<div class="col-lg-12">
	...
	<div class="content-panel" style="padding:10px 10px;margin-bottom:200px">
		...
		@foreach($slider->chunk(4) as $data)
		<div class="row mt">
				...
				<div class="project-wrapper">
					<div class="project">
						<div class="photo-wrapper">
							<div class="photo">
								<a class="fancybox" href="{{URL::to('upload/slider/'. $value['photo'])}}"><img class="img-thumbnail" src="{{URL::to('upload/slider/'. $value['photo'])}}" alt=""></a>
							</div>
			...
			<span class="pull-right">{{$slider->render()}}</span>
			</div>
		</div>
			@endsection
			@section('customJs')
			...
			<script type="text/javascript">
				$('.delete').on('click', function(e) {
						...
						$.confirm({
							...
							buttons: {
							confirm: function () {
							$.get("{{ route('admin.getDeleteSlider') }}", {id: id}, function (data) {
								// console.log(data);
								location.reload();
							});
							},
