    ...
    public function getDataSiswa(Request $request) {
        ...
        $datatables = DataTables::of($data)
          ...
          ->addColumn('action', function($data) {
            return '<a href="/ppdb/admin/data/siswa/'.$data->id.'/detail" class="btn btn-info"><i class="fa fa-search"></i></a> <a href="#!" class="btn btn-danger delete" data-id="'.$data->id.'"><i class="fa fa-trash"></i></a>';
          })
          ->addIndexColumn();
